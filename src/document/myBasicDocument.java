 ...
 */
public class myBasicDocument extends myDocument 
{
	/** Create a new BasicDocument object
	 * 
	 * @param text The full text of the Document.
	 */
	public myBasicDocument(String text)
	{
		super(text);
	}
	...
	public int getNumWords()
	{
		...
		// See the Module 2 support videos if you need help.
            //System.out.println("");
            //System.out.println("WORDS: "+this.getTokens("[a-zA-Z]+"));
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
            //System.out.println("");
            //System.out.println("QUIZ: "+this.getTokens("[a-z]+|[()0-9]+"));
	...
	public int getNumSyllables()
	{
		...
		// and then call it here on each word.
            int totalNumOfSyll = 0;
            
            List<String> lista = this.getTokens("[a-zA-Z]+");
            for(String e:lista){
                totalNumOfSyll += countSyllables(e);
            }
        return totalNumOfSyll;
	}
	...
	public static void main(String[] args)
	{
		 ...
		 */
            ...
            //0     
            //System.out.println("--------------------------------------------------------");
            testCase(new BasicDocument("lalalaaa! lala, la!"),6, 3, 2);
